const cacheUrl = [
  './309.8a6333f5fc2b3e0f.js',
  './3rdpartylicenses.txt',
  './assets/data/dashboard.json',
  './assets/data/jobandskill.json',
  './assets/data/menu.json',
  './assets/fonts/flUhRq6tzZclQEJ-Vdg-IuiaDsNcIhQ8tQ.woff2',
  ...
  './assets/images/matero.png',
  './favicon.ico',
  './index.html',
  './main.9071c01fc114d63a.js',
  './polyfills.a68c3e8c4e8265c3.js',
  './runtime.cd95186c459ce3d0.js',
  './serviceWorker.js',
  './styles.da8023eae4e352f8.css'
];
