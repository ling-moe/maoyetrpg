...
export interface SkillControl {
  ...
  ini: FormControl<number>;
  grow: FormControl<number | undefined>;
  pro: FormControl<number | undefined>;
  interest: FormControl<number | undefined>;
...
export interface Skill extends SkillValue {
  bz: boolean;
  introduce: string;
  name: string;
  num: number;
...
export type JobName =
  | keyof Omit<Gedou, 'all'>
  | keyof Omit<Jiashi, 'all'>
  | keyof Omit<Jiyi, 'all'>
  | keyof Omit<Kexue, 'all'>
  | keyof Omit<Muyu, 'all'>
  | keyof Omit<Sheji, 'all'>
  | keyof Omit<Shengcun, 'all'>
  | keyof Omit<Waiyu, 'all'>;
